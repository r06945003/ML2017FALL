...
X_train, Y_train, X_test = readFile(sys.argv[3]), readFile(sys.argv[4]), readFile(sys.argv[5])
#X_train, Y_train, X_test = readFile('X_train'), readFile('Y_train'), readFile('X_test')
